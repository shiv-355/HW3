...
public class SetupAccountPage {
    ...
    public void show(Stage primaryStage) {
        ...
        setupButton.setOnAction(a -> {
            ...
            // Call username recognizer to validate the new username
            ...
            // Call Password evaluator to validate the password
            ...
            try {
                ...
                if (!databaseHelper.doesUserExist(userName)) {
                    ...
                    if (role != null) {  // If the role exists, the invite is valid
                        ...
                        switch (role.toLowerCase()) {
                            ...
                            case "student":
                                ...
                                break;
                            case "teacher":
                                new TeacherHomePage(databaseHelper).show(primaryStage);
                                break;
                           /* case "reviewer":
